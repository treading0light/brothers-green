globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/coding_projects/brothers-green/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file://C:/coding_projects/brothers-green/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, useQuery, useCookie, createError, createApp, createRouter, lazyEventHandler, eventHandler } from 'file://C:/coding_projects/brothers-green/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/coding_projects/brothers-green/node_modules/ohmyfetch/dist/node.mjs';
import destr from 'file://C:/coding_projects/brothers-green/node_modules/destr/dist/index.mjs';
import { createRouter as createRouter$1 } from 'file://C:/coding_projects/brothers-green/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/coding_projects/brothers-green/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/coding_projects/brothers-green/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://C:/coding_projects/brothers-green/node_modules/ohash/dist/index.mjs';
import { parseURL, withQuery, withLeadingSlash, withoutTrailingSlash, joinURL } from 'file://C:/coding_projects/brothers-green/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/coding_projects/brothers-green/node_modules/unstorage/dist/index.mjs';
import _unstorage_drivers_fs from 'file://C:/coding_projects/brothers-green/node_modules/unstorage/dist/drivers/fs.mjs';
import { extname } from 'file://C:/coding_projects/brothers-green/node_modules/pathe/dist/index.mjs';
import defu from 'file://C:/coding_projects/brothers-green/node_modules/defu/dist/defu.mjs';
import remarkEmoji from 'file://C:/coding_projects/brothers-green/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file://C:/coding_projects/brothers-green/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file://C:/coding_projects/brothers-green/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file://C:/coding_projects/brothers-green/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file://C:/coding_projects/brothers-green/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file://C:/coding_projects/brothers-green/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://C:/coding_projects/brothers-green/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://C:/coding_projects/brothers-green/node_modules/rehype-raw/index.js';
import yaml from 'file://C:/coding_projects/brothers-green/node_modules/js-yaml/dist/js-yaml.mjs';
import flat from 'file://C:/coding_projects/brothers-green/node_modules/flat/index.js';
import { unified } from 'file://C:/coding_projects/brothers-green/node_modules/unified/index.js';
import remarkParse from 'file://C:/coding_projects/brothers-green/node_modules/remark-parse/index.js';
import remark2rehype from 'file://C:/coding_projects/brothers-green/node_modules/remark-rehype/index.js';
import { snakeCase, kebabCase, pascalCase } from 'file://C:/coding_projects/brothers-green/node_modules/scule/dist/index.mjs';
import { visit } from 'file://C:/coding_projects/brothers-green/node_modules/unist-util-visit/index.js';
import { stringifyEntitiesLight } from 'file://C:/coding_projects/brothers-green/node_modules/stringify-entities/index.js';
import { parseEntities } from 'file://C:/coding_projects/brothers-green/node_modules/parse-entities/index.js';
import { markdownLineEnding, markdownSpace, asciiAlpha, markdownLineEndingOrSpace, asciiAlphanumeric } from 'file://C:/coding_projects/brothers-green/node_modules/micromark-util-character/dev/index.js';
import { factorySpace } from 'file://C:/coding_projects/brothers-green/node_modules/micromark-factory-space/dev/index.js';
import { factoryWhitespace } from 'file://C:/coding_projects/brothers-green/node_modules/micromark-factory-whitespace/dev/index.js';
import { codeFenced } from 'file://C:/coding_projects/brothers-green/node_modules/micromark-core-commonmark/dev/index.js';
import { all } from 'file://C:/coding_projects/brothers-green/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file://C:/coding_projects/brothers-green/node_modules/detab/index.js';
import { u } from 'file://C:/coding_projects/brothers-green/node_modules/unist-builder/index.js';
import { encode } from 'file://C:/coding_projects/brothers-green/node_modules/mdurl/index.js';
import { position } from 'file://C:/coding_projects/brothers-green/node_modules/unist-util-position/index.js';
import htmlTags from 'file://C:/coding_projects/brothers-green/node_modules/html-tags/index.js';
import slugify from 'file://C:/coding_projects/brothers-green/node_modules/slugify/slugify.js';
import { createRenderer } from 'file://C:/coding_projects/brothers-green/node_modules/vue-bundle-renderer/dist/index.mjs';
import devalue from 'file://C:/coding_projects/brothers-green/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/coding_projects/brothers-green/node_modules/vue/server-renderer/index.mjs';
import htmlTemplate from 'file://C:/coding_projects/brothers-green/nuxt-build/views/document.template.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routes":{},"envPrefix":"NUXT_"},"public":{"content":{"base":"_content","tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":false,"wsUrl":"ws://localhost:4000/"}},"content":{"cacheVersion":2,"cacheIntegerity":"cN8Gkpfl2c","transformers":["C:/coding_projects/brothers-green/node_modules/@nuxt/content/dist/runtime/server/transformers/markdown.mjs","C:/coding_projects/brothers-green/node_modules/@nuxt/content/dist/runtime/server/transformers/yaml.mjs","C:/coding_projects/brothers-green/node_modules/@nuxt/content/dist/runtime/server/transformers/json.mjs","C:/coding_projects/brothers-green/node_modules/@nuxt/content/dist/runtime/server/transformers/csv.mjs","C:/coding_projects/brothers-green/node_modules/@nuxt/content/dist/runtime/server/transformers/path-meta.mjs"],"base":"_content","watch":true,"sources":["content"],"ignores":["\\.","-"],"locales":[],"highlight":false,"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"rehypePlugins":[],"remarkPlugins":[]},"yaml":{},"csv":{},"navigation":{"fields":[]}}};
...
const serverAssets = [{"baseName":"server","dir":"C:/coding_projects/brothers-green/server/assets"}];
...
storage.mount('content:source:content', _unstorage_drivers_fs({"name":"content","driver":"fs","prefix":"","base":"C:\\coding_projects\\brothers-green\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"C:\\coding_projects\\brothers-green","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"C:\\coding_projects\\brothers-green\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"C:\\coding_projects\\brothers-green\\nuxt-build","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"C:\\coding_projects\\brothers-green\\nuxt-build\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47markdown_46mjs = {
  name: "markdown",
  extentions: [".md"],
...
const C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47yaml_46mjs = {
  name: "Yaml",
  extentions: [".yml", ".yaml"],
  parse: async (_id, content) => {
...
const C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47json_46mjs = {
  name: "Json",
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/coding_projects/brothers-green/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47csv_46mjs = {
  name: "csv",
  extentions: [".csv"],
  parse: async (_id, content) => {
    const config = { ...useRuntimeConfig().content?.csv || {} };
    const csvToJson = await import('file://C:/coding_projects/brothers-green/node_modules/csvtojson/v2/index.js').then((m) => m.default || m);
...
const C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47path_45meta_46mjs = {
  name: "path-meta",
  extentions: [".*"],
  transform(content) {
...
const transformers = [C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47markdown_46mjs, C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47yaml_46mjs, C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47json_46mjs, C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47csv_46mjs, C_58_47coding_projects_47brothers_45green_47node_modules_47_64nuxt_47content_47dist_47runtime_47server_47transformers_47path_45meta_46mjs];
...
const _1Z0EVI = defineEventHandler(async (event) => {
...
const _1p7jCC = defineEventHandler(async (event) => {
  const now = Date.now();
...
const _VAAN3W = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_DG63CZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_DG63CZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid', handler: _1Z0EVI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _1Z0EVI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache', handler: _1p7jCC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _VAAN3W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _VAAN3W, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_DG63CZ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/coding_projects/brothers-green/nuxt-build/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/coding_projects/brothers-green/nuxt-build/dist/server/server.mjs').then((r) => r.default || r);
